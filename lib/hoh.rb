...
def naming_system
  hash = {
    label: "Kingdom", sub_category: {
      label: "Phylum", sub_category: {label: "Class", sub_category:{label: "Order", sub_category:{label: "Family",sub_category:{label: "Genus", sub_category: {label: "Species", sub_category: nil}}}}}}}

end

#   hash = {
#     sub_category: {label: "Kindom"},
...
#     sub_category: {label: "Species", sub_category: nil}
# }
